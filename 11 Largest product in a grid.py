def largest_adjacent_product_grid(grid, length):
    answer = 0
    grid_size = len(grid)
    for x in range(0, grid_size - 1):
        for y in range(0, grid_size - length):
            product = 1
            for i in range(0, length):
                product *= matrix[x][y + i]
                if product > answer:
                    answer = product
    for x in range(0, grid_size - length):
    ...
    for x in range(0, grid_size - length):
        for y in range(0, grid_size - length):
            ...
            for i in range(0, length):
                ...
                if product > answer:
                    answer = product
    for x in range(length - 1, grid_size - 1):
        for y in range(0, grid_size - length):
            product = 1
            for i in range(0, length):
                product *= matrix[x - i][y + i]
...
print(largest_adjacent_product_grid(matrix, 4))
